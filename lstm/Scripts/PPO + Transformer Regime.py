# === PPO + Transformer Regime Portfolio Trainer ===
...
# === Setup and Train ===
env = DummyVecEnv([lambda: TransformerEnv(returns, trans_regimes)])
model = PPO("MlpPolicy", env, verbose=1)
model.learn(total_timesteps=100_000)
model.save("ppo_transformer_regime")
...
# === Plot NAV ===
plt.plot(navs)
plt.title("PPO + Transformer Regime NAV Curve")
plt.xlabel("Step")
plt.ylabel("NAV")
plt.grid(True)
plt.savefig("ppo_transformer_nav_curve.png")
plt.show()
